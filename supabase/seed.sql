...
('homepage', '{"eyebrow":"Private trading education · Invite only","headline":"Stop guessing. Start trading with structure.","description":"A sequential, video-led curriculum built by full-time traders — price action, risk management and execution, taught in order and tested at every step.","trustLine":"TRUSTED BY 300+ ACTIVE TRADERS WORLDWIDE","heroImageUrl":"/images/hero-trading.svg","heroTerminalImageUrl":"/images/hero-trading.svg","ctaImageUrl":"https://images.unsplash.com/photo-1590283603385-17ffb3a7f29f?w=1400&q=80&auto=format&fit=crop"}'::jsonb),
